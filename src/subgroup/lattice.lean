...
/- I have commented this out since this conflicts with the inf generated by gi
...
-- subgroups_ge therefore it also forms a distributive lattice. But it turns out 
-- the subgroups of G do not form a distributive lattice in general so the code 
-- below is *dead*.
